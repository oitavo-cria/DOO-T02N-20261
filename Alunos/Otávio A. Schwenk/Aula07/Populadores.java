...
public class Populadores {
    ...
    public static void popularLojasVendedoresClientes(){
        ...
        Vendedor vendedorUm = new Vendedor(
            ...
            37, 
            lojaDois, 
            lojaDois.getEndereco().getCidade(), 
            "Alamedas", 
            "Tuatui", 
            2500.00, 
            salariosUm);
            ...
            22, 
            lojaTres, 
            lojaTres.getEndereco().getCidade(), 
            "Capela", 
            "Brando Gado", 
            2655.00, 
            salariosQuatro);
            ...
            lojaUm.adicionarFuncionario(gerenteUm);
            lojaUm.adicionarFuncionario(vendedorUm);
            lojaDois.adicionarFuncionario(vendedorTres);
            lojaTres.adicionarFuncionario(vendedorDois);
        ...
        Gestao.funcionarios.add(gerenteUm);
